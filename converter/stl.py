...
'''
TODO: set ocl.so library and camvtk.py from https://github.com/aewallin/opencamlib
      as dependency  them translate this c++ code to python and use opencamlib to convert files
      design this module for being imported from a service.
